...
An official Stata contour enhanced funnel plot command, based on `confunnel` is available since [Stata version 16](https://www.stata.com/stata16/meta-analysis/), through the [`meta funnelplot`](https://www.stata.com/manuals/metametafunnelplot.pdf) command as follows
